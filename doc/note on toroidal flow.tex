...
Actually, we only need to declare a new variable ${\tt omega}$, then \texttt{ut=-omega*radius}, see {\bf Appendix}.
...
omega(nr)---$\omega$, angular frequency of toroidal flow\\
domega(nr)---d$\omega$/dr\\
