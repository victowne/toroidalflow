...
We have 
\begin{equation}
    Centrifugal\ force\ :\ F_{cf} = m_a\omega^2R\hat{R}
\end{equation}
\begin{equation}
    Coriolis\ force\ :\ F_{co} = 2m_av_\parallel\hat{b}\times\hat{\omega}
\end{equation}
...
\begin{equation}
    \frac{F_{co}\times\hat{b}}{e_aB} = \frac{2m_av_\parallel}{e_aB} \hat{b}\times\hat{\omega}\times\hat{b}
\end{equation}
