...
\begin{equation}
    \langle R^2 \rangle=\lim _{\delta \mathcal{V} \rightarrow 0} \frac{1}{\delta \mathcal{V}} \int_{\delta \mathcal{V}} R^2 \mathcal{J} dr d \theta d \zeta=\frac{d r}{d V} \int_{0}^{2 \pi} \int_{0}^{2 \pi} R^2 \mathcal{J} d \theta d \zeta
\end{equation}
